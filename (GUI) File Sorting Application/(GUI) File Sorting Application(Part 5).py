...
class Sorting_App:
    def __init__(self,root):
        ...
        self.audio_extensions=["Audio Extentions",".mp3",".wav",".amr",".m4a"]
        ...
        self.lbl_total_images=Label(Frame1,text="Total Images:0",font=("times new roman",15,"bold"),bg="#0875B7",fg="white",image=self.image_icon,compound=TOP,bd=2,relief=RAISED)
        self.lbl_total_images.place(x=20,y=60,width=230,height=230)
        
        self.lbl_total_audios=Label(Frame1,text="Total Audios:0",font=("times new roman",15,"bold"),bg="#008EA4",fg="white",image=self.audio_icon,compound=TOP,bd=2,relief=RAISED)
        self.lbl_total_audios.place(x=260,y=60,width=230,height=230)
        
        self.lbl_total_videos=Label(Frame1,text="Total Videos:0",font=("times new roman",15,"bold"),bg="#DF002A",fg="white",image=self.video_icon,compound=TOP,bd=2,relief=RAISED)
        self.lbl_total_videos.place(x=500,y=60,width=230,height=230)
        
        self.lbl_total_docs=Label(Frame1,text="Total Documents:0",font=("times new roman",15,"bold"),bg="#008EA4",fg="white",image=self.document_icon,compound=TOP,bd=2,relief=RAISED)
        self.lbl_total_docs.place(x=740,y=60,width=230,height=230)
        
        self.lbl_total_others=Label(Frame1,text="Others:0",font=("times new roman",15,"bold"),bg="gray",fg="white",image=self.other_icon,compound=TOP,bd=2,relief=RAISED)
        ...
        """Total Files"""
        self.lbl_st_total=Label(self.root,text="TOTAL : 0",font=("times new roman",18),bg="white",fg="green")
        self.lbl_st_total.place(x=300,y=620)
        
        """Files Moved"""
        self.lbl_st_moved=Label(self.root,text="MOVED : 0",font=("times new roman",18),bg="white",fg="blue")
        self.lbl_st_moved.place(x=500,y=620)
        
        """Files Left"""
        self.lbl_st_left=Label(self.root,text="LEFT : 0",font=("times new roman",18),bg="white",fg="orange")
        self.lbl_st_left.place(x=700,y=620)
        
        
        """Button Clear"""
        self.btn_clear=Button(self.root,text="CLEAR",font=("times new roman",15,"bold"),bg="#607d8b",fg="white",activebackground="#607d8b",activeforeground="white",cursor="hand2")
        self.btn_clear.place(x=880,y=610,height=40,width=200)
        
        """Button Start"""
        self.btn_start=Button(self.root,text="START",font=("times new roman",15,"bold"),bg="#ff5722",fg="white",activebackground="#ff5722",activeforeground="white",cursor="hand2")
    ...
    def Total_count(self):
        ...
        self.lbl_total_files.config(text="Total Files:"+str(count))
