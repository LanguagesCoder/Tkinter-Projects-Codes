...
class EmployeeSystem:
    def __init__(self,root):
        ...
        txt_absent=Entry(Frame2,font=("times new roman",15),bg="lightyellow",fg="black",textvariable=self.var_pf).place(x=420,y=155,width=120)
        ...
        txt_netsalary=Entry(Frame2,font=("times new roman",15),bg="lightyellow",fg="black",textvariable=self.var_net_salary).place(x=420,y=185,width=120)
    ...
    def calculate(self):
        ...
        self.var_dob.get(),
        self.var_doj.get(),
        self.var_proof_id.get(), #Adhaar Card
