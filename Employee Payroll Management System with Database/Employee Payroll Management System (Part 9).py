...
class EmployeeSystem:
    def __init__(self,root):
        ...
        btn_save=Button(Frame2,text="Save",font=("times new roman",20),bg="green",fg="white",command=self.add).place(x=285,y=225,height=30,width=120)        
        btn_clear=Button(Frame2,text="Clear",font=("times new roman",20),bg="gray",fg="black").place(x=420,y=225,height=30,width=120)        
        btn_update=Button(Frame2,text="Update",font=("times new roman",20),bg="blue",fg="white",command=self.calculate).place(x=150,y=260,height=30,width=180)        
        btn_delete=Button(Frame2,text="Delete",font=("times new roman",20),bg="red",fg="white",command=self.add).place(x=340,y=260,height=30,width=200)        
