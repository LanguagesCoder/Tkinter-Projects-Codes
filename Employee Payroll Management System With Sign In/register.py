...
class Register :
    def __init__(self,root):
        ...
        bg=Label(self.root,image=self.bg,bg="white").place(x=250,y=0,relwidth=1,relheight=1)
    
    
        #Left Image
        self.left=ImageTk.PhotoImage(file='images/side.png')
        left=Label(self.root,image=self.left,bg="white",bd=2,relief=RIDGE).place(x=80,y=100,width=400,height=500)
        ...
        self.txt_fname=Entry(frame1,font=("times new roman",15,"bold"),bg="light gray",fg="black")
        self.txt_fname.place(x=50,y=130,width=250)
        
        l_name=Label(frame1,text="Last Name",font=("times new roman",15,"bold"),bg="white",fg="black").place(x=370,y=100)
        self.txt_lname=Entry(frame1,font=("times new roman",15,"bold"),bg="light gray",fg="black")
        self.txt_lname.place(x=370,y=130,width=250)
        
        #--------------------------------------------------------------------------------------Row 2
        contact=Label(frame1,text="Contact No.",font=("times new roman",15,"bold"),bg="white",fg="black").place(x=50,y=170)
        self.txt_contact=Entry(frame1,font=("times new roman",15,"bold"),bg="light gray",fg="black")
        self.txt_contact.place(x=50,y=200,width=250)
        
        email=Label(frame1,text="Email/Username",font=("times new roman",15,"bold"),bg="white",fg="black").place(x=370,y=170)
        self.txt_email=Entry(frame1,font=("times new roman",15,"bold"),bg="light gray",fg="black")
        ...
        self.txt_answer=Entry(frame1,font=("times new roman",15,"bold"),bg="light gray",fg="black")
        self.txt_answer.place(x=370,y=270,width=250)
        
        #--------------------------------------------------------------------------------------Row 4
        password=Label(frame1,text="Password",font=("times new roman",15,"bold"),bg="white",fg="black").place(x=50,y=310)
        self.txt_password=Entry(frame1,font=("times new roman",15,"bold"),bg="light gray",fg="black")
        self.txt_password.place(x=50,y=340,width=250)
        
        cpassword=Label(frame1,text="Confirm Password",font=("times new roman",15,"bold"),bg="white",fg="black").place(x=370,y=310)
        self.txt_cpassword=Entry(frame1,font=("times new roman",15,"bold"),bg="light gray",fg="black")
        self.txt_cpassword.place(x=370,y=340,width=250)
        
        #--------------------------------------------------------------------------------------Terms
        self.var_chk=IntVar()
        chk=Checkbutton(frame1,text="I Agree The Terms & Conditions",bg="white",fg="black",font=("times new roman",12),activebackground="white",onvalue=1,offvalue=0,variable=self.var_chk).place(x=50,y=380)        
        
        #Button
        self.btn_image=ImageTk.PhotoImage(file="images/register.png")
        btn_register=Button(frame1,image=self.btn_image,bd=0,cursor="hand2",command=self.register_data).place(x=50,y=420)
        
        btn_login=Button(self.root,text="Sign In",bd=0,cursor="hand2",font=("times new roman",20),command=self.sign_in).place(x=200,y=480,width=180,height=30)
    ...
    def register_data(self):
        if self.txt_fname.get() == '' or self.txt_lname.get() == '' or self.txt_contact.get() == '' or self.txt_email.get() == '' or self.cmb_quest.get() == 'Select' or self.txt_answer.get() == '' or self.txt_password.get() == '' or self.txt_cpassword.get() == '':
            ...
            try:
                ...
                row=cur.fetchone()
                if row != None:
                    messagebox.showerror("Email Exist","The Email YOu Have Entered Is Alredy Registered Please Enter Another Email ID")
                else:
