...
class Login_Window:
    ...
    def forget_password_window(self):
        if self.txt_email.get()=="":
            messagebox.showerror("Error","Please Fill Up The Email For Changing The Password",parent=self.root2)
    ...
    def login(self):
        ...
        try:
            ...
            if row == None:
                ...
                messagebox.showinfo("Logined","Welcome")
                self.root.destroy()
                import Employee_Payroll_Management_System
